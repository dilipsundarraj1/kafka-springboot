...
////                .build();
        ...
        //when
        ResponseEntity<Webhook> responseEntity = restTemplate.exchange("http://localhost:8000/logpoint-webhook/alert/notification", HttpMethod.POST, request, Webhook.class);
